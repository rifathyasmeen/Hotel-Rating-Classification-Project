...
st.markdown('This application is build on the machine learning model-Logistic Regression ')
...
logistic=load(open("C:\\Users\\RIFATH-LAPTOP\\logistic_model_deploy.pkl","rb"))
tfid=load(open("C:\\Users\\RIFATH-LAPTOP\\tfid_deploy.pkl","rb"))
